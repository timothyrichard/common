...
[![build status](https://github.com/timothyrichard/common/badges/master/build.svg)](https://github.com/timothyrichard/common/commits/master) [![coverage report](https://github.com/timothyrichard/common/badges/master/coverage.svg)](https://github.com/timothyrichard/common/commits/master)
...
## Installation
```bash
- go get github.com/timothyrichard/common
```
